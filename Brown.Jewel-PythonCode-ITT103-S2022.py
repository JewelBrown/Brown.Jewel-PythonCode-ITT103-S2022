...
#This statement uses nested function to get salesperson number as well as assign value to the variable
nu_mber= int(input ('Enter salesperson number: '))

#This statement uses nested function to get sales amount as well as assign value to the variable
sales= int(input ('Enter sales amount: '))

#This statement uses nested function to get class as well as assign value to the variable
...
#If statement determining if class is 1
 ...
 #commission is returned to where the function was called
 return commission
